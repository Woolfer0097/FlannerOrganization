...
import 'CalorieGainScreen.dart';  // Import the new screen
...
class MainScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final List<Widget> screens = [
      ...
      SportScreen(),
      CalorieGainScreen(),  // Add the CalorieGainScreen
    ];
    ...
    final List<AppBar> appBars = [
      ...
      AppBar(
        title: Text('Habit Tracker', style: textStyle, textAlign: TextAlign.center),
        backgroundColor: theme.scaffoldBackgroundColor,
        actions: [
          Builder(
      ...
      AppBar(
        title: Text('Calories Gained Calculator', style: textStyle),
        backgroundColor: theme.scaffoldBackgroundColor,
        actions: [
          ElevatedButton(
            onPressed: () => ref.read(themeNotifierProvider.notifier).changeTheme(),
        ...
        home: Scaffold(
          ...
          bottomNavigationBar: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(icon: Icon(Icons.local_dining), label: "Calories"),  // Add a new item for Calorie Gain
            ],
          ),
        ),
      ),
